...
public enum CatalogIndustry {
	GOVERNMENT("GOVERNMENT"), AGROPECUARY("AGROPECUARY"), WHOLESALE("WHOLESALE"), RETAIL("RETAIL"),
	CONSTRUCTION("CONSTRUCTION"), MEDIA("MEDIA"), MINERY("MINERY"), MANUFACTURING("MANUFACTURING"), ENERGY("ENERGY"),
	OTHER_NON_GOVERNMENTAL_SERVICES("OTHER NON GOVERNMENTAL SERVICES"), HOSPITALITY("HOSPITALITY"),
	RESTAURANTS("RESTAURANTS"), CULTURE_LEISURE("CULTURE & LEISURE"), HEALTH("HEALTH"), EDUCATION("EDUCATION"),
	FINANCIAL_SERVICES("FINANCIAL SERVICES"), REAL_ESTATE("REAL ESTATE"),
	PROFESSIONAL_SCIENTIFIC_TECHNICAL_SERVICES("PROFESSIONAL, SCIENTIFIC & TECHNICAL SERVICES"), CARGO("CARGO"),
	TRANSPORT("TRANSPORT");
