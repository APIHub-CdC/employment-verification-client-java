package com.cdc.apihub.mx.employmentVerification.client;
...
public class ApiClient {
	...
	public static OkHttpClient getClientNoSSLVerification() {
		try {
			...
			Builder okHttpClient = new OkHttpClient().newBuilder().sslSocketFactory(sslSocketFactory, trustManager)
